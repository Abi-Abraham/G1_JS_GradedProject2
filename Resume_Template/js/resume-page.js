...
// Fills the data in all the html placeholders based on currently selected resume
const fillData = () => {
...
//fetch("../resources/data/Data.json") //this threw CORS error hence uploaded json file to npoint
